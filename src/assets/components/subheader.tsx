...
function WalletOptions() {
    return (
        <div className='flex items-center p-2 gap-2 border border-neutral-200 rounded-md cursor-pointer'>
...
function ClearAll() {
    return (
        <button className='flex items-center p-2 border border-neutral-200 rounded-md cursor-pointer'>
